...
List<Opportunity> oppList = [SELECT Id, Name, SA_Internal_Notes__c, Pre_Qual_Notes__c, Internal_QC_Notes__c, Internal_Underwriting_Notes__c, Processing_Notes__c, Underwriting_Notes__c, Third_Party_UW_Notes__c, UW_Notes_to_Processing_Risk_Department__c FROM Opportunity WHERE Id IN: TestOppId];
